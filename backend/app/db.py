...
def _run_migrations(conn: DuckDBPyConnection) -> None:
    ...
    conn.execute(_STOCK_PICKER_AI_EVALUATION_TABLE_SQL)
...
_STOCK_PICKER_BACKTEST_TABLE_SQL = """
CREATE SEQUENCE IF NOT EXISTS stock_picker_backtest_seq START 1;
CREATE TABLE IF NOT EXISTS stock_picker_backtests (
    id INTEGER PRIMARY KEY DEFAULT nextval('stock_picker_backtest_seq'),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    pool_type TEXT NOT NULL,
...
_STOCK_PICKER_AI_EVALUATION_TABLE_SQL = """
CREATE SEQUENCE IF NOT EXISTS stock_picker_ai_evaluation_seq START 1;
CREATE TABLE IF NOT EXISTS stock_picker_ai_evaluations (
    id INTEGER PRIMARY KEY DEFAULT nextval('stock_picker_ai_evaluation_seq'),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    pool_type TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_stock_picker_ai_evaluation_created
ON stock_picker_ai_evaluations(created_at DESC);
"""
...
_SECURITY_UNIVERSE_SNAPSHOT_TABLE_SQL = """
CREATE TABLE IF NOT EXISTS security_universe_snapshots (
    ...
    payload TEXT NOT NULL,
    UNIQUE (market, observation_date, snapshot_version)
);
CREATE INDEX IF NOT EXISTS idx_security_universe_snapshot_captured
